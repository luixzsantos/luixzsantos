# ⚡ Luiz Fernando Araujo Santos | Offensive Security & Software Developer 🛡️

<p align="left">
  <img src="https://img.shields.io/badge/Status-Active%20Learning-green?style=flat-square" />
  <img src="https://img.shields.io/badge/Focus-Pentest%20%26%20FullStack-red?style=flat-square" />
...
I build secure and scalable applications using modern frameworks and databases.
...
Experience with enterprise-grade distributions and security monitoring.
...
* **Linux Administration:** Hands-on experience with **Rocky Linux 9**, focusing on RHEL-based environments.
* **Secure Coding:** Implementing security best practices in **Spring Boot** and **Java** applications.
* **Web Hacking:** Deep dives into **OWASP Top 10** vulnerabilities (XSS, IDOR, SSRF).
